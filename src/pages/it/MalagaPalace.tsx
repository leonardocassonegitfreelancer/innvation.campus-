    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-end">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pb-14 w-full">
          <a href="/it" className="inline-flex items-center gap-2 text-white/70 hover:text-white text-sm font-body mb-4 transition-colors">
        ...
        <div ref={aboutRef} className={`scroll-animate ${aboutVis ? "visible" : ""} max-w-6xl mx-auto px-6`}>
          <div className="flex flex-col-reverse md:grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button asChild variant="outline" className="mt-6 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-body text-sm uppercase tracking-widest px-6 py-3 w-fit"><a href="/it/trovaci#malaga-palace">Trovaci</a></Button>
            </div>
