    ...
    <main className="overflow-x-hidden">
      <section className="bg-neutral-dark pt-28 pb-16 md:pt-36 md:pb-20">
        <div className="max-w-6xl mx-auto px-6">
          <a href="/it" className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm font-body mb-6 transition-colors">
            <ArrowLeft className="w-4 h-4" />
            Torna alla Home
          </a>
          <h1 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground">Blog</h1>
          <p className="font-body text-lg md:text-xl text-primary-foreground/60 mt-3 max-w-2xl">Idee, approfondimenti e storie dalla comunità Innovation Campus.</p>
        </div>
      </section>
                  ...
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex items-center gap-4 text-xs text-muted-foreground font-body">
                      <span className="flex items-center gap-1">
                        ...
                        {new Date(post.date).toLocaleDateString("it-IT", { month: "short", day: "numeric", year: "numeric" })}
                      </span>
                      <span className="flex items-center gap-1">
