      ...
      <main className="overflow-x-hidden">
        ...
        <section className="relative h-[60vh] min-h-[400px] flex items-end">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 pb-12 w-full">
            ...
            <p className="font-body text-lg md:text-xl text-primary-foreground/70 mt-3 max-w-2xl">
              Inspiring workspaces. International community. Real impact.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="font-body text-xs uppercase tracking-[0.3em] text-primary mb-4 font-semibold">Our Mission</p>
              ...
              <p className="font-body text-foreground/70 text-lg leading-relaxed mb-4">
                Innovation Campus provides companies, startups, and entrepreneurs with professional and stylish workspaces, outstanding service, and the opportunity to be part of a thriving entrepreneurial community.
              </p>
              <p className="font-body text-foreground/70 text-lg leading-relaxed">
                We operate in mid-size cities that offer the right balance between successful business and quality of life — places where great ideas can grow without the noise of a megalopolis.
              </p>
            </div>
            <img
        ...
        <section className="py-20 bg-background">
          <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            />
            <div>
              <p className="font-body text-xs uppercase tracking-[0.3em] text-primary mb-4 font-semibold">What We Do</p>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-6 leading-tight">
        ...
        <section className="py-16 bg-muted/30 border-t border-border">
          <div className="max-w-5xl mx-auto px-6 text-center mb-12">
            <p className="font-body text-xs uppercase tracking-[0.3em] text-primary mb-4 font-semibold">Our Locations</p>
            <h2 className="font-display text-3xl font-bold text-foreground">Spain & Italy</h2>
          </div>
