  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(170deg, #C8442A, #b33d26, #a03722)",
        }}
      >
        <div ref={aboutRef} className={`scroll-animate ${aboutVis ? "visible" : ""} max-w-6xl mx-auto px-6`}>
          ...
          <div className="flex flex-wrap gap-2 mt-12">
            {highlights.map((h) => (
              <span
                key={h}
                className="inline-flex items-center gap-1 font-body text-xs px-3 py-1.5 rounded-full bg-white/10 text-primary-foreground/80"
              >
