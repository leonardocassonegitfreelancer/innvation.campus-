...
const translations = {
  en: {
    ...
    services: [
      { title: "Meeting Rooms", desc: "Conferences, workshops & events", href: "/en/lead?service=meeting-rooms", img: conferencePicasso },
      { title: "Private Terrace", desc: "Outdoor events & receptions", href: "/en/lead?service=private-terrace", img: terraceHero },
      { title: "Private Office", desc: "Dedicated office spaces", href: "/en/lead?service=private-office", img: palaceSecondFloor },
      { title: "Coworking", desc: "Flexible desks & memberships", href: "/en/lead?service=coworking", img: palaceCoworking },
      { title: "Business Registration", desc: "Domicile your company", href: "/en/lead?service=business-registration", img: palaceBrandingWall },
  ...
  es: {
    ...
    services: [
      { title: "Salas de Reuniones", desc: "Conferencias, talleres y eventos", href: "/es/lead?service=meeting-rooms", img: conferencePicasso },
      { title: "Terraza Privada", desc: "Eventos al aire libre y recepciones", href: "/es/lead?service=private-terrace", img: terraceHero },
      { title: "Oficina Privada", desc: "Espacios de oficina dedicados", href: "/es/lead?service=private-office", img: palaceSecondFloor },
      { title: "Coworking", desc: "Puestos y membresías flexibles", href: "/es/lead?service=coworking", img: palaceCoworking },
      { title: "Registro de Empresa", desc: "Domicilia tu empresa", href: "/es/lead?service=business-registration", img: palaceBrandingWall },
  ...
  it: {
    ...
    services: [
      { title: "Sale Riunioni", desc: "Conferenze, workshop ed eventi", href: "/it/lead?service=meeting-rooms", img: conferencePicasso },
      { title: "Terrazza Privata", desc: "Eventi outdoor e ricevimenti", href: "/it/lead?service=private-terrace", img: terraceHero },
      { title: "Ufficio Privato", desc: "Spazi ufficio dedicati", href: "/it/lead?service=private-office", img: palaceSecondFloor },
      { title: "Coworking", desc: "Postazioni e abbonamenti flessibili", href: "/it/lead?service=coworking", img: palaceCoworking },
      { title: "Domiciliazione", desc: "Domicilia la tua azienda", href: "/it/lead?service=business-registration", img: palaceBrandingWall },
