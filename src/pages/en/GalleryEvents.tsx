...
const translations = {
  ...
  es: {
    ...
    subtitle: "Momentos de nuestros eventos comunitarios.",
    filters: [
  ...
  it: {
    ...
    subtitle: "Momenti dei nostri eventi comunitari.",
    filters: [
...
export default function GalleryEvents({ lang = "en" }: { lang?: "en" | "es" | "it" }) {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="relative h-[50vh] min-h-[360px] flex items-end">
        <img src={_s(serviceCommunity)} alt="Innovation Campus events" className="absolute inset-0 w-full h-full object-cover" />
