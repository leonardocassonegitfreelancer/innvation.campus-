...
import terraceRooftop from "@/assets/terrace-rooftop.jpg";
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-end">
        <img src={terraceRooftop} alt="Málaga Terrace rooftop" className="absolute inset-0 w-full h-full object-cover" />
