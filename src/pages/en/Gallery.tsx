...
const photos: PhotoItem[] = [
  ...
  { src: palaceCoffeeBar, alt: { en: "Bistro and coffee bar area for networking", es: "Bistró y zona de café para networking", it: "Area bistrot e caffè per networking" }, category: { en: "Bistro & Coffee", es: "Bistró y Café", it: "Bistrot & Caffè" }, location: { en: "Málaga Palace", es: "Málaga Palace", it: "Málaga Palace" }, filter: "palace" },
  ...
  { src: largeConference03, alt: { en: "Projector and interactive presentation area", es: "Proyector y área de presentación interactiva", it: "Proiettore e area interattiva per presentazioni" }, category: { en: "Boardroom", es: "Sala Ejecutiva", it: "Sala Boardroom" }, location: { en: "Málaga Center", es: "Málaga Centro", it: "Málaga Centro" }, filter: "meetings" },
  ...
  { src: largeConference09, alt: { en: "Boardroom layout with projector and whiteboard", es: "Sala de juntas con proyector y pizarra", it: "Sala riunioni con proiettore e lavagna" }, category: { en: "Digital Boardroom", es: "Sala Digital", it: "Sala Digitale" }, location: { en: "Málaga Center", es: "Málaga Centro", it: "Málaga Centro" }, filter: "meetings" },
  ...
  { src: bigConference10, alt: { en: "Glass conference room with projector and whiteboard", es: "Sala de conferencias de cristal con proyector y pizarra", it: "Sala conferenze vetrata con proiettore e lavagna" }, category: { en: "Conference Suite", es: "Sala Ejecutiva", it: "Sala Executive" }, location: { en: "Málaga Center", es: "Málaga Centro", it: "Málaga Centro" }, filter: "meetings" },
  ...
  { src: bigConference22, alt: { en: "Large boardroom with modern furniture and full AV setup", es: "Sala de juntas grande con mobiliario moderno y equipo AV completo", it: "Sala board ampia con arredi moderni e dotazione AV completa" }, category: { en: "Boardroom", es: "Sala de Juntas", it: "Sala Riunioni" }, location: { en: "Málaga Center", es: "Málaga Centro", it: "Málaga Centro" }, filter: "meetings" },
  ...
  { src: quarterConference02, alt: { en: "Team discussion room with projector and whiteboard", es: "Sala de discusión de equipos con proyector y pizarra", it: "Sala riunioni con proiettore e lavagna" }, category: { en: "Team Room", es: "Sala de Equipos", it: "Sala del Team" }, location: { en: "Málaga Center", es: "Málaga Centro", it: "Málaga Centro" }, filter: "meetings" },
  ...
  { src: trainingRoom04, alt: { en: "Interactive lecturing tables with TV and whiteboard", es: "Mesas de conferencias interactivas con TV y pizarra", it: "Sala lezioni interattiva con TV e lavagna" }, category: { en: "Training Room", es: "Sala de Formación", it: "Sala Formazione" }, location: { en: "Training Hub", es: "Centro de Formación", it: "Spazio Formazione" }, filter: "meetings" },
