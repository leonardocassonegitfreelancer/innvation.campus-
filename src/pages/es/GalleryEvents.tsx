...
const photos: { src: string; alt: string; filter: Filter }[] = [
  { src: serviceCommunity, alt: "Evento comunitario en Innovation Campus", filter: "networking" },
  { src: terraceEvents, alt: "Eventos en Málaga Terrace", filter: "networking" },
  { src: terraceCommunity, alt: "Sesión de networking", filter: "networking" },
  { src: palaceCatering, alt: "Catering en evento Innovation Campus", filter: "networking" },
  { src: palaceCourtyard, alt: "Evento exterior Málaga Palace", filter: "talk" },
  { src: terraceBar, alt: "Networking drinks en Málaga Terrace", filter: "workshop" },
];
...
export default function GalleryEventsES() {
  ...
  return (
    <>
      <SEOHead
        title="Galería de Eventos — Innovation Campus"
        description="Fotos de eventos comunitarios, noches de networking, talleres y charlas en Innovation Campus Málaga."
        path="/es/galeria/eventos"
      />
      <main className="overflow-x-hidden">
        <Navbar />
        <section className="relative h-[50vh] min-h-[360px] flex items-end">
          <img src={serviceCommunity} alt="Eventos Innovation Campus" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 pb-12 w-full">
            ...
            <h1 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground">Galería de Eventos</h1>
            <p className="font-body text-lg text-primary-foreground/70 mt-3">Momentos de nuestros eventos comunitarios.</p>
          </div>
        </section>
