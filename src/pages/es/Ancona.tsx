...
export default function AnconaES() {
  ...
  return (
    <main className="overflow-x-hidden">
      <SEOHead
        title="Espacio de Coworking en Ancona"
        description="Un espacio de coworking moderno en el centro histórico de Ancona. Escritorios flexibles, salas de reuniones y comunidad."
        path="/es/ancona"
      />
      <Navbar />
      ...
      <section className="relative h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
        <img src={_s(anconaHero)} alt="Vista panorámica de Ancona" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-black/50" />
        <div className="relative z-10 text-center">
          <h1 className="font-display text-5xl md:text-7xl font-bold text-primary-foreground tracking-tight">Ancona</h1>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className="max-w-6xl mx-auto px-6">
          <div ref={aboutRef} className={`scroll-animate ${aboutVis ? "visible" : ""}`}>
            <p className="font-body text-sm text-muted-foreground line-through text-center mb-2">Innovation Campus Ancona</p>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground text-center mb-12">Innovation Campus Ancona</h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <ul className="space-y-3 mb-8">
                  <li className="font-body text-foreground"><a href="#" className="underline hover:text-primary transition-colors">• Coworking en Ancona</a></li>
                  <li className="font-body text-foreground"><a href="#" className="underline hover:text-primary transition-colors">• Hermoso para vivir y trabajar en Ancona</a></li>
                  <li className="font-body text-foreground"><a href="#" className="underline hover:text-primary transition-colors">• Una gran compañía de trabajo</a></li>
                </ul>
                <Button asChild className="bg-primary text-primary-foreground hover:bg-primary/90 font-body uppercase tracking-widest">
                  <a href="#contact-ancona">Reserva tu visita</a>
                </Button>
              </div>
              <div className="rounded-xl overflow-hidden shadow-lg">
                <img src={_s(anconaCoworking)} alt="Espacio de coworking Innovation Campus Ancona" className="w-full h-72 object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-neutral-dark py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="font-body text-xs uppercase tracking-[0.3em] text-primary mb-2">Innovation Campus Ancona</p>
              <h3 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-6">Nuestro Espacio de Coworking en Ancona</h3>
            ...
            <div>
              <h4 className="font-body text-lg font-semibold text-primary-foreground mb-3">IN/C Ancona coworking</h4>
              <p className="font-body text-sm text-primary-foreground/70 leading-relaxed">
                Un espacio de coworking moderno y profesionalmente diseñado en el centro histórico de Ancona, a poca distancia de todas las comodidades y puntos de interés principales.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="contact-ancona" className="py-20 md:py-28 bg-neutral-dark">
        <div className="max-w-3xl mx-auto px-6">
          <div ref={contactRef} className={`scroll-animate ${contactVis ? "visible" : ""} text-center`}>
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-foreground mb-4">Visita Innovation Campus Ancona</h2>
            <p className="font-body text-primary-foreground/60 mb-8">Ven a ver nuestro espacio de coworking en el corazón de Ancona.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10 text-primary-foreground/70">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-body text-sm">Lun–Vie 9:00–19:00</span>
              </div>
            </div>
