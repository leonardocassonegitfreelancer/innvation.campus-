  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="relative h-[50vh] md:h-[60vh] flex items-center justify-center overflow-hidden">
        <img src={anconaHero} alt="Vista panorámica de Ancona" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div ref={aboutRef} className={`scroll-animate ${aboutVis ? "visible" : ""}`}>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-xl overflow-hidden shadow-lg">
                <img src={anconaCoworking} alt="Espacio de coworking Innovation Campus Ancona" className="w-full h-72 object-cover" />
              </div>
            </div>
          </div>
        </div>
