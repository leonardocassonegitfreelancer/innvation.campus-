...
export const spacesDataset: SpaceData[] = [
...

  {
    ...
    baseRoute: "meeting-rooms",
    translations: {
      en: { label: "Training", name: "Training Room — 4th Floor", capacityText: "Up to 30 people" },
      es: { label: "Formación", name: "Sala de Formación — 4º Piso", capacityText: "Hasta 30 personas" },
      it: { label: "Formazione", name: "Sala Formazione — 4° Piano", capacityText: "Fino a 30 persone" },
    },
    amenities: {
      en: ["TV", "Microphone", "Whiteboard", "Speaker", "High-Speed WiFi", "4th Floor", "42m²", "Catering Available", "Events Allowed"],
      es: ["TV", "Micrófono", "Pizarra", "Altavoz", "WiFi Alta Velocidad", "4º Piso", "42m²", "Catering Disponible", "Eventos Permitidos"],
      it: ["TV", "Microfono", "Lavagna", "Altoparlante", "WiFi Alta Velocità", "4° Piano", "42m²", "Catering Disponibile", "Eventi Consentiti"],
    },
  },
