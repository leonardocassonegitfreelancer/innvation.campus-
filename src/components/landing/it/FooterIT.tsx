    ...
    <footer className="text-white font-body" style={{ backgroundColor: "#1A1A1A" }}>
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr_0.8fr_0.8fr] gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="text-xs text-white/60 leading-tight">
                <p className="font-semibold text-white/80">Finanziato da</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-xs text-white/60 leading-tight">
                <p>Piano di Recupero,</p>
                <p>Trasformazione e Resilienza</p>
              </div>
            </div>
          </div>
          ...
          {/* Column 2 — Contact */}
          <div>
            <h4 className="text-white/40 text-sm font-light italic mb-6">Contatti</h4>
            <div className="space-y-3 text-sm text-white/70">
              <p>Málaga Palace (Centro Storico): <a href="tel:+34671441288" className="hover:text-primary transition-colors">+34 671 44 12 88</a></p>
              <p>Málaga Terrace (Sul Mare): <a href="tel:+34676943978" className="hover:text-primary transition-colors">+34 676 94 39 78</a></p>
              <p>Ancona/Olbia: <a href="tel:+393383355908" className="hover:text-primary transition-colors">+39 338 335 5908</a></p>
              <p>Direzione Málaga: <a href="tel:+34673737235" className="hover:text-primary transition-colors">+34 673 737235</a></p>
            </div>
          </div>

          {/* Column 3 — Locations */}
          <div>
            <h4 className="text-white/40 text-sm font-light italic mb-6">Sedi</h4>
            <div className="space-y-3 text-sm text-white/70">
              <Link to="/it/malaga-palace" className="block hover:text-primary transition-colors">Málaga Palace</Link>
              <Link to="/it/malaga-terrace" className="block hover:text-primary transition-colors">Málaga Terrace</Link>
              <Link to="/it/ancona" className="block hover:text-primary transition-colors">Ancona</Link>
              <Link to="/it/olbia" className="block hover:text-primary transition-colors">Olbia</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/70">
              <a href="#" className="block hover:text-primary transition-colors">Uso dei Cookie</a>
              <a href="#" className="block hover:text-primary transition-colors">Note Legali</a>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/40">
            ©{new Date().getFullYear()} - Innovation Campus. Tutti i Diritti Riservati
          </p>
        </div>
      </div>
    </footer>
