      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
          ...
          <div ref={r1} className={`scroll-animate ${v1 ? "visible" : ""} w-full md:w-1/2`} style={{ transitionDelay: "0.15s" }}>
            <p className="font-body text-xs uppercase tracking-[0.4em] text-primary mb-4">Il Campus</p>
            <h2 className="text-4xl md:text-5xl lg:text-6xl leading-none mb-6 uppercase text-secondary bg-inherit font-medium" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              TRA SPAGNA E ITALIA, UN PROGETTO CHE NON SI FERMA MAI
            </h2>
            ...
            <div className="space-y-4 font-body text-base leading-relaxed text-historic-muted">
              <p className="text-secondary">
                Innovation Campus è un coworking indipendente presente in due paesi, due culture e due modi di lavorare:
                Offriamo spazi a Málaga, Olbia e Ancona con gli occhi sempre puntati sulle persone che costruiscono qualcosa di reale.
              </p>
              <p className="text-secondary">A Málaga siamo in due posti che non potrebbero essere più diversi.</p>
              <p className="text-secondary">
                <strong className="bg-inherit text-primary">Málaga Palace</strong>, nel cuore del centro storico, tra le mura di un palazzo storico affrescato e restaurato: dove il silenzio e la storia camminano accanto a te mentre lavori.
              </p>
              <p className="text-secondary">
