...
const translations = {
  en: {
    ...
    features: [
      ...
      "Capacity from 10 to 100+ guests",
    ],
    statsLabel: ["Events Hosted", "Capacity", "Palace & Terrace"],
    statsValue: ["500+", "100+", "2"],
  ...
  es: {
    ...
    features: [
      ...
      "Capacidad para 10 a 100+ personas",
    ],
    statsLabel: ["Eventos Realizados", "Capacidad Máx.", "Palace & Terrace"],
    statsValue: ["500+", "100+", "2"],
  ...
  it: {
    ...
    features: [
      ...
      "Capacità da 10 a 100+ ospiti",
    ],
    statsLabel: ["Eventi Ospitati", "Capienza Max", "Palace & Terrace"],
    statsValue: ["500+", "100+", "2"],
