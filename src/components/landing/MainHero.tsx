...
export default function MainHero() {
  ...
  return (
    <section className="relative h-[85vh] md:h-screen md:max-h-screen bg-[hsl(var(--neutral-dark))] overflow-hidden">
      {/* Slideshow images */}
      {slides.map((src, i) =>
      <img
        key={i}
      ...
      {/* Content centered */}
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20 pb-8 md:pt-0 md:pb-0">
        {/* Locations */}
        <p
