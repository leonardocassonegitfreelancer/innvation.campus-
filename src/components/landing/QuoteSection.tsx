...
export default function QuoteSection() {
  ...
  return (
    <section className="relative py-10 md:py-14 bg-neutral-dark overflow-hidden">
      {/* Subtle texture */}
      ...
      <div className="max-w-5xl mx-auto px-6 text-center" ref={ref}>
        <div className={`scroll-animate ${isVisible ? "visible" : ""}`}>
          <div className="text-primary text-5xl md:text-7xl font-display leading-none mb-4">"</div>
          ...
          <p className="font-body text-white/40 text-sm mt-4 uppercase tracking-widest">
            Innovation/Campus
          </p>
        </div>
      </div>
