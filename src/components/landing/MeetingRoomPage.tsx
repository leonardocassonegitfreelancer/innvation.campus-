...
const fullTerracePhotosGlob = import.meta.glob('@/assets/full-terrace-*.webp', { eager: true });
const fullTerracePhotos = Object.values(fullTerracePhotosGlob).map((mod: any) => getSrc(mod.default || mod));
...
const rooms: RoomData[] = [
  {
    ...
    highlight: true,
    seo: {
      en: { title: "Big Conference Room", description: "Our flagship conference room for up to 80 people (76 chairs) with projector, microphone, whiteboard and speaker. 86m² on the ground floor in Málaga." },
      es: { title: "Gran Sala de Conferencias – City Center Picasso", description: "Nuestra sala principal para hasta 80 personas (76 sillas) con proyector, micrófono, pizarra y altavoz. 86m² en planta baja en Málaga." },
      it: { title: "Grande Sala Conferenze – City Center Picasso", description: "La nostra sala principale per fino a 80 persone (76 sedie) con proiettore, microfono, lavagna e altoparlante. 86m² al piano terra a Málaga." },
    },
    ...
    features: {
      en: ["Projector", "Microphone & Speaker", "Whiteboard", "Flexible Layout"],
      es: ["Proyector", "Micrófono y Altavoz", "Pizarra", "Disposición Flexible"],
      it: ["Proiettore", "Microfono e Altoparlante", "Lavagna", "Layout Flessibile"],
    },
    description: {
    ...
    amenities: {
      en: ["High-Speed WiFi", "Projector", "Microphone", "Whiteboard", "Speaker", "Climate Control", "Catering Available", "Reception Support", "Secure Access"],
      es: ["WiFi Alta Velocidad", "Proyector", "Micrófono", "Pizarra", "Altavoz", "Climatización", "Catering Disponible", "Soporte Recepción", "Acceso Seguro"],
      it: ["WiFi Alta Velocità", "Proiettore", "Microfono", "Lavagna", "Altoparlante", "Climatizzazione", "Catering Disponibile", "Supporto Reception", "Accesso Sicuro"],
    },
    facilitiesCategories: {
      en: [
        { category: "AV & Technology", items: ["Projector", "Microphone", "Whiteboard", "Speaker"] },
        { category: "Connectivity", items: ["High-Speed WiFi", "Multiple Power Outlets"] },
        { category: "Space", items: ["86.48 x 3.80m", "Ground Floor", "76 Chairs"] },
        { category: "Services", items: ["Catering Available", "Reception Support", "Secure Access", "Dedicated Coordinator"] },
      ],
      es: [
        { category: "AV y Tecnología", items: ["Proyector", "Micrófono", "Pizarra", "Altavoz"] },
        { category: "Conectividad", items: ["WiFi Alta Velocidad", "Múltiples Enchufes"] },
        { category: "Espacio", items: ["86.48 x 3.80m", "Planta Baja", "76 Sillas"] },
        { category: "Servicios", items: ["Catering Disponible", "Soporte Recepción", "Acceso Seguro", "Coordinador Dedicado"] },
      ],
      it: [
        { category: "AV e Tecnologia", items: ["Proiettore", "Microfono", "Lavagna", "Altoparlante"] },
        { category: "Connettività", items: ["WiFi Alta Velocità", "Prese Multiple"] },
        { category: "Spazio", items: ["86.48 x 3.80m", "Piano Terra", "76 Sedie"] },
  ...
  },
  {
    ...
    seo: {
      en: { title: "Large Conference Room", description: "A versatile conference room for up to 50 people (44 chairs) with projector, microphone, whiteboard and speaker. 48m² on the ground floor in Málaga." },
      es: { title: "Large Conference Room", description: "Una sala versátil para hasta 50 personas (44 sillas) con proyector, micrófono, pizarra y altavoz. 48m² en planta baja en Málaga." },
      it: { title: "Large Conference Room", description: "Una sala versatile per fino a 50 persone (44 sedie) con proiettore, microfono, lavagna e altoparlante. 48m² al piano terra a Málaga." },
    },
    ...
    features: {
      en: ["Projector", "Microphone & Speaker", "Whiteboard", "Boardroom Setup"],
      es: ["Proyector", "Micrófono y Altavoz", "Pizarra", "Mesa de Juntas"],
      it: ["Proiettore", "Microfono e Altoparlante", "Lavagna", "Configurazione Boardroom"],
    },
    description: {
    ...
    facilitiesCategories: {
      en: [
        ...
        { category: "Space", items: ["48.8 x 3.80m", "Ground Floor", "44 Chairs"] },
      ...
      es: [
        ...
        { category: "Espacio", items: ["48.8 x 3.80m", "Planta Baja", "44 Sillas"] },
      ...
      it: [
        ...
        { category: "Spazio", items: ["48.8 x 3.80m", "Piano Terra", "44 Sedie"] },
  ...
  },
  {
    ...
    seo: {
      en: { title: "Quarter Conference Room", description: "An intimate conference room for up to 30 people (32 chairs) with projector, microphone, whiteboard and speaker. 38m² on the ground floor in Málaga." },
      es: { title: "Quarter Conference Room", description: "Una sala íntima para hasta 30 personas (32 sillas) con proyector, micrófono, pizarra y altavoz. 38m² en planta baja en Málaga." },
      it: { title: "Quarter Conference Room", description: "Una sala intima per fino a 30 persone (32 sedie) con proiettore, microfono, lavagna e altoparlante. 38m² al piano terra a Málaga." },
    },
    ...
    features: {
      en: ["Projector", "Microphone & Speaker", "Whiteboard", "Intimate Setting"],
      es: ["Proyector", "Micrófono y Altavoz", "Pizarra", "Ambiente Íntimo"],
      it: ["Proiettore", "Microfono e Altoparlante", "Lavagna", "Ambiente Intimo"],
    },
    description: {
    ...
    facilitiesCategories: {
      en: [
        { category: "AV & Technology", items: ["Projector", "Microphone", "Whiteboard", "Speaker"] },
        { category: "Connectivity", items: ["High-Speed WiFi", "Power Outlets"] },
        { category: "Space", items: ["38.0 x 3.80m", "Ground Floor", "32 Chairs"] },
        { category: "Services", items: ["Catering Available", "Reception Support", "Secure Access"] },
      ],
      es: [
        { category: "AV y Tecnología", items: ["Proyector", "Micrófono", "Pizarra", "Altavoz"] },
        { category: "Conectividad", items: ["WiFi Alta Velocidad", "Enchufes"] },
        { category: "Espacio", items: ["38.0 x 3.80m", "Planta Baja", "32 Sillas"] },
        { category: "Servicios", items: ["Catering Disponible", "Soporte Recepción", "Acceso Seguro"] },
      ],
      it: [
        { category: "AV e Tecnologia", items: ["Proiettore", "Microfono", "Lavagna", "Altoparlante"] },
        { category: "Connettività", items: ["WiFi Alta Velocità", "Prese"] },
        { category: "Spazio", items: ["38.0 x 3.80m", "Piano Terra", "32 Sedie"] },
        { category: "Servizi", items: ["Catering Disponibile", "Supporto Reception", "Accesso Sicuro"] },
      ],
    },
    layouts: {
  ...
  },
  {
    ...
    features: {
      en: ["TV", "Whiteboard", "High-Speed WiFi", "Catering Available"],
      es: ["TV", "Pizarra", "WiFi Alta Velocidad", "Catering Disponible"],
      it: ["TV", "Lavagna", "WiFi Alta Velocità", "Catering Disponibile"],
    },
    description: {
    ...
    amenities: {
      en: ["High-Speed WiFi", "TV", "Whiteboard", "Climate Control", "Catering Available", "Secure Access"],
      es: ["WiFi Alta Velocidad", "TV", "Pizarra", "Climatización", "Catering Disponible", "Acceso Seguro"],
      it: ["WiFi Alta Velocità", "TV", "Lavagna", "Climatizzazione", "Catering Disponibile", "Accesso Sicuro"],
    },
    facilitiesCategories: {
      en: [
        { category: "AV & Technology", items: ["TV", "Whiteboard"] },
        { category: "Connectivity", items: ["High-Speed WiFi", "Power Outlets"] },
        { category: "Space", items: ["7.0m²", "2nd Floor", "6 Chairs"] },
        { category: "Services", items: ["Catering Available", "Secure Access"] },
      ],
      es: [
        { category: "AV y Tecnología", items: ["TV", "Pizarra"] },
        { category: "Conectividad", items: ["WiFi Alta Velocidad", "Enchufes"] },
        { category: "Espacio", items: ["7.0m²", "2º Piso", "6 Sillas"] },
        { category: "Servicios", items: ["Catering Disponible", "Acceso Seguro"] },
      ],
      it: [
        { category: "AV e Tecnologia", items: ["TV", "Lavagna"] },
        { category: "Connettività", items: ["WiFi Alta Velocità", "Prese"] },
        { category: "Spazio", items: ["7.0m²", "2° Piano", "6 Sedie"] },
  ...
  },
  {
    ...
    capacity: { en: "1 person", es: "1 persona", it: "1 persona" },
    ...
    features: {
      en: ["Soundproofed", "Private Access", "High-Speed WiFi"],
      es: ["Insonorizada", "Acceso Privado", "WiFi Alta Velocidad"],
      it: ["Insonorizzata", "Accesso Privato", "WiFi Alta Velocità"],
    },
    description: {
    ...
    amenities: {
      en: ["High-Speed WiFi", "Soundproofing", "Climate Control", "Secure Access"],
      es: ["WiFi Alta Velocidad", "Insonorización", "Climatización", "Acceso Seguro"],
      it: ["WiFi Alta Velocità", "Insonorizzazione", "Climatizzazione", "Accesso Sicuro"],
    },
    facilitiesCategories: {
      en: [
        { category: "Connectivity", items: ["High-Speed WiFi"] },
        { category: "Space", items: ["1 x 1 x 2.30m", "Ground Floor", "1 Chair"] },
        { category: "Comfort", items: ["Climate Control", "Soundproofing"] },
        { category: "Services", items: ["Secure Access"] },
      ],
      es: [
        { category: "Conectividad", items: ["WiFi Alta Velocidad"] },
        { category: "Espacio", items: ["1 x 1 x 2.30m", "Planta Baja", "1 Silla"] },
        { category: "Confort", items: ["Climatización", "Insonorización"] },
        { category: "Servicios", items: ["Acceso Seguro"] },
      ],
      it: [
        { category: "Connettività", items: ["WiFi Alta Velocità"] },
        { category: "Spazio", items: ["1 x 1 x 2.30m", "Piano Terra", "1 Sedia"] },
        { category: "Comfort", items: ["Climatizzazione", "Insonorizzazione"] },
        { category: "Servizi", items: ["Accesso Sicuro"] },
      ],
    },
    layouts: {
      en: [{ name: "Individual", capacity: 1, icon: "boardroom" }],
      es: [{ name: "Individual", capacity: 1, icon: "boardroom" }],
      it: [{ name: "Individuale", capacity: 1, icon: "boardroom" }],
    },
  },
  {
  ...
  },
  {
    ...
    features: {
      en: ["TV", "Microphone", "Whiteboard", "Speaker", "High-Speed WiFi", "4th Floor · 42m²"],
      es: ["TV", "Micrófono", "Pizarra", "Altavoz", "WiFi Alta Velocidad", "4º Piso · 42m²"],
      it: ["TV", "Microfono", "Lavagna", "Altoparlante", "WiFi Alta Velocità", "4° Piano · 42m²"],
    },
    description: {
      en: "Training room on the 4th floor of Málaga Terrace, 42m² with capacity for 30 people (20 chairs). Equipped with TV, microphone, whiteboard and speaker. Catering and events allowed.",
      es: "Sala de formación en el 4º piso de Málaga Terrace, 42m² con capacidad para 30 personas (20 sillas). Equipada con TV, micrófono, pizarra y altavoz. Catering y eventos permitidos.",
      it: "Sala formazione al 4° piano di Málaga Terrace, 42m² con capacità per 30 persone (20 sedie). Dotata di TV, microfono, lavagna e altoparlante. Catering ed eventi consentiti.",
    },
    useCases: {
      en: ["Training days", "Team workshops", "Presentations", "Meetings", "Events"],
      es: ["Jornadas de formación", "Talleres de equipo", "Presentaciones", "Reuniones", "Eventos"],
      it: ["Giornate di formazione", "Workshop di team", "Presentazioni", "Riunioni", "Eventi"],
    },
    amenities: {
      en: ["High-Speed WiFi", "TV", "Microphone", "Whiteboard", "Speaker", "42m²", "4th Floor", "Catering Available", "Events Allowed"],
      es: ["WiFi Alta Velocidad", "TV", "Micrófono", "Pizarra", "Altavoz", "42m²", "4º Piso", "Catering Disponible", "Eventos Permitidos"],
      it: ["WiFi Alta Velocità", "TV", "Microfono", "Lavagna", "Altoparlante", "42m²", "4° Piano", "Catering Disponibile", "Eventi Consentiti"],
    },
    facilitiesCategories: {
      en: [
        { category: "AV & Technology", items: ["TV", "Microphone", "Whiteboard", "Speaker"] },
        { category: "Connectivity", items: ["High-Speed WiFi", "Power Outlets"] },
        { category: "Space", items: ["4th Floor", "42m²", "Terrace Access"] },
        { category: "Services", items: ["Catering Available", "Events Allowed"] },
      ],
      es: [
        { category: "AV y Tecnología", items: ["TV", "Micrófono", "Pizarra", "Altavoz"] },
        { category: "Conectividad", items: ["WiFi Alta Velocidad", "Enchufes"] },
        { category: "Espacio", items: ["4º Piso", "42m²", "Acceso Terraza"] },
        { category: "Servicios", items: ["Catering Disponible", "Eventos Permitidos"] },
      ],
      it: [
        { category: "AV e Tecnologia", items: ["TV", "Microfono", "Lavagna", "Altoparlante"] },
        { category: "Connettività", items: ["WiFi Alta Velocità", "Prese"] },
        { category: "Spazio", items: ["4° Piano", "42m²", "Accesso Terrazza"] },
        { category: "Servizi", items: ["Catering Disponibile", "Eventi Consentiti"] },
      ],
    },
    layouts: {
      en: [
  ...
  },
  {
    ...
    description: {
      ...
      es: "Nuestro espacio exterior principal en la azotea de Málaga Terrace, disponible en exclusiva. Perfecto para eventos corporativos, lanzamientos de productos, fiestas privadas y veladas de networking bajo el cielo de Málaga con vistas panorámicas al mar y la ciudad.",
      it: "Il nostro spazio esterno principale sul rooftop di Málaga Terrace, disponibile in esclusiva. Perfetto per eventi aziendali, lanci di prodotti, feste private e serate di networking con vista panoramica sul mare e sulla città.",
    },
    useCases: {
      en: ["Corporate events", "Product launches", "Private parties", "Networking evenings", "Team celebrations"],
      es: ["Eventos corporativos", "Lanzamientos de productos", "Fiestas privadas", "Veladas de networking", "Celebraciones de equipo"],
  ...
  },
  {
    ...
    description: {
      ...
      es: "La mitad de nuestra terraza en azotea para un ambiente más íntimo, sin renunciar a las vistas. Ideal para eventos corporativos más pequeños, celebraciones de equipo, recepciones de cócteles y cenas privadas con vistas al mar.",
      it: "Metà della nostra terrazza sul rooftop per un'atmosfera più intima, senza rinunciare alla vista. Ideale per eventi aziendali più piccoli, celebrazioni di team, ricevimenti cocktail e cene private con vista sul mare.",
    },
    useCases: {
      en: ["Intimate corporate events", "Team celebrations", "Cocktail receptions", "Private dinners", "Small networking events"],
      es: ["Eventos corporativos íntimos", "Celebraciones de equipo", "Recepciones de cócteles", "Cenas privadas", "Networking reducido"],
...
const roomPaths: Record<string, Record<string, string>> = {
  en: {
    ...
    "half-terrace": "/en/private-terrace/half-terrace",
  },
  es: {
    ...
    "half-terrace": "/es/terraza-privada/half-terrace",
  },
  it: {
    ...
    "half-terrace": "/it/terrazza-privata/half-terrace",
  },
};
