...
const images = [
  { src: palaceCoworking, alt: "Área de coworking abierta en Palace" },
  { src: palaceCoffeeBar, alt: "Zona de café y bar" },
  { src: terraceCommunity, alt: "Espacio comunitario en la terraza" },
];
