...
const translations = {
  en: {
    ...
    items: [
      ...
      { icon: Music, label: "Open Bar   { icon: Wind, label: "Covered Areas" },
  ...
  es: {
    ...
    items: [
      ...
      { icon: Music, label: "SistOpenOpen Bar: Wind, label: "Zonas Cubiertas" },
  ...
  it: {
    ...
    items: [
      ...
      { icon: Music, label: "Sistema AudioOpen Baricon: Wind, label: "Aree Coperte" },
