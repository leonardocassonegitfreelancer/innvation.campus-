...
const terraceGalleryTop = [
  { src: _s(img_terrace_reception), alt: "Málaga Terrace entrance" },
  { src: _s(img_terrace_cafe), alt: "Málaga Terrace bar area" },
  { src: _s(img_terrace_interior), alt: "Málaga Terrace interior" },
...
const terraceGalleryBottom = [
  ...
  { src: _s(img_terrace_coworking_alt), alt: "Coworking at Málaga Terrace" },
