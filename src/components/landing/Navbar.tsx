...
const linksEN = { location: [{ label: "Málaga Palace", href: "/en/malaga-palace" }, { label: "Málaga Terrace", href: "/en/malaga-terrace" }, { label: "Ancona", href: "/en/ancona" }, { label: "Olbia", href: "/en/olbia" }], business: [{ label: "Meeting Rooms", href: "/en/meeting-rooms" }, { label: "Private Terrace", href: "/en/private-terrace" }, { label: "Private Offices", href: "/en/private-offices" }, { label: "Business Registration", href: "/en/business-registration" }, { label: "Spaces Gallery", href: "/en/gallery/spaces" }], individual: [{ label: "Coworking & Pricing", href: "/en/coworking-space" }, { label: "Community Events", href: "/en/events" }, { label: "Events Gallery", href: "/en/gallery/events" }, { label: "Academy", href: "/en/academy" }, { label: "Member Perks", href: "/en/benefits" }], nav: [{ label: "Host Your Event", href: "/en/host-your-event" }, { label: "About Us", href: "/en/about-us" }, { label: "Blog", href: "/blog" }, { label: "Find Us", href: "/en/find-us" }], labels: { locations: "Locations", forBusinesses: "For Businesses", forIndividuals: "For Individuals", getInTouch: "Get in Touch" }, home: "/" };
const linksES = { location: [{ label: "Málaga Palace", href: "/es/malaga-palace" }, { label: "Málaga Terrace", href: "/es/malaga-terrace" }, { label: "Ancona", href: "/es/ancona" }, { label: "Olbia", href: "/es/olbia" }], business: [{ label: "Salas de Reuniones", href: "/es/salas-de-reuniones" }, { label: "Terraza Privada", href: "/es/terraza-privada" }, { label: "Oficinas Privadas", href: "/es/oficinas-privadas" }, { label: "Registro de Empresas", href: "/es/registro-de-empresas" }, { label: "Galería de Espacios", href: "/es/galeria/espacios" }], individual: [{ label: "Coworking y Precios", href: "/es/coworking" }, { label: "Eventos", href: "/es/eventos" }, { label: "Galería de Eventos", href: "/es/galeria/eventos" }, { label: "Academia", href: "/es/academia" }, { label: "Beneficios", href: "/es/beneficios" }], nav: [{ label: "Organiza Tu Evento", href: "/es/organiza-tu-evento" }, { label: "Quiénes Somos", href: "/es/quienes-somos" }, { label: "Blog", href: "/es/blog" }, { label: "Encuéntranos", href: "/es/encuentranos" }], labels: { locations: "Ubicaciones", forBusinesses: "Para Empresas", forIndividuals: "Para Individuos", getInTouch: "Contacto" }, home: "/es" };
const linksIT = { location: [{ label: "Málaga Palace", href: "/it/malaga-palace" }, { label: "Málaga Terrace", href: "/it/malaga-terrace" }, { label: "Ancona", href: "/it/ancona" }, { label: "Olbia", href: "/it/olbia" }], business: [{ label: "Sale Riunioni", href: "/it/sale-riunioni" }, { label: "Terrazza Privata", href: "/it/terrazza-privata" }, { label: "Uffici Privati", href: "/it/uffici-privati" }, { label: "Registrazione Aziendale", href: "/it/registrazione-aziendale" }, { label: "Galleria Spazi", href: "/it/galleria/spazi" }], individual: [{ label: "Coworking e Prezzi", href: "/it/coworking" }, { label: "Eventi", href: "/it/eventi" }, { label: "Galleria Eventi", href: "/it/galleria/eventi" }, { label: "Academy", href: "/it/academy" }, { label: "Vantaggi", href: "/it/vantaggi" }], nav: [{ label: "Organizza Evento", href: "/it/organizza-evento" }, { label: "Chi Siamo", href: "/it/chi-siamo" }, { label: "Blog", href: "/it/blog" }, { label: "Trovaci", href: "/it/trovaci" }], labels: { locations: "Sedi", forBusinesses: "Per Aziende", forIndividuals: "Per Individui", getInTouch: "Contatti" }, home: "/it" };
